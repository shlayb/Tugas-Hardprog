...
int main(){
  ...
  // test case DTI ke rumah wkwk
  // -7.7726134310564, 110.37856759023725, 100
  point[0].latitude = -7.7726134310564;
  point[0].longitude = 110.37856759023725;
  point[0].altitude = 100;
  // -7.83844837323259, 110.40359346888482
  point[1].latitude = -7.83844837323259;
  point[1].longitude = 110.40359346888482;
  point[1].altitude = 100;
